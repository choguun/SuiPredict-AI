...
import { AGENT_POLICY_PACKAGE_ID, resolveAgentPolicyPackageId, } from "../constants.js";
...
// without a rebuild.
export const MARKET_PACKAGE_ID = (process.env.NEXT_PUBLIC_MARKET_PACKAGE_ID ??
    process.env.MARKET_PACKAGE_ID ??
    AGENT_POLICY_PACKAGE_ID).trim();
export function resolveMarketPackageId() {
