...
export async function findExistingYesPool(
  ...
  const KNOWN_V3_POOLS: Record<string, Record<string, string>> = {
    ...
    "0xe14eba90fc8cc14a2eac1199b207d4e664931f8196f612b5aacf0c4a7f7d7a6f": {
      ...
      "0xe98b0c9c215859ef937803ca9a2f4f94fd649c3a701fcb5b6850c115d9773dac":
        "0xc566210dda11ab4cd38739d2ec00c0dde54d38176f1340fc4d3d50acb3de07f6",
    },
  };
  ...
  process.stdout.write(
    `###V3PROBE### MARKER-A:${deepbookRegistryId} MARKER-B:${marketPackageId} ` +
      `MARKER-C:${!!knownRegistryPools} MARKER-D:${!!knownPoolId}\n`,
  );
  process.stderr.write(
    `###V3PROBE-STDERR### MARKER-A:${deepbookRegistryId} MARKER-B:${marketPackageId} ` +
      `MARKER-C:${!!knownRegistryPools} MARKER-D:${!!knownPoolId}\n`,
  );
  console.error(
    `###V3PROBE-CERR### MARKER-A:${deepbookRegistryId} MARKER-B:${marketPackageId}`,
  );
  if (knownPoolId) {
    console.warn(
