...
export declare function listMarkets(limit?: number, offset?: number): MarketInfo[];
...
export declare function getPortfolio(address: string, limit?: number, offset?: number): PortfolioPosition[];
