    ...
    <html lang="en" className="dark">
      ...
      >
        <Providers>
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[200] focus:rounded-lg focus:border focus:border-cyan-500/50 focus:bg-panel-strong focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-cyan-200 focus:shadow-lg"
          >
            Skip to content
          </a>
          <Nav />
